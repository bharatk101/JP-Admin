...
import bharat.example.com.jp.utility.FilePaths;
...
public class SettingsActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mEmail = (EditText) findViewById(R.id.settings_email);
        mCurrentPassword = (EditText) findViewById(R.id.settings_password);
        mSave= (Button) findViewById(R.id.save);
        mProgressBar = (ProgressBar) findViewById(R.id.progressBar4);
        mResetPasswordLink = (TextView) findViewById(R.id.chnagepassword);
        mName = (EditText) findViewById(R.id.settings_name);
        mPhone = (EditText) findViewById(R.id.settings_phone);
    ...
    private void init(){
        ...
        mSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!mName.getText().toString().equals("") && mName.getText().toString() != nm){
                ...
                ------ Change Phone Number -----
                 */
                if(!mPhone.getText().toString().equals("") && mPhone.getText().toString() != pn){
                    reference.child(getString(R.string.dbnode_users))
                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
